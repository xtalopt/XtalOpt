...
msym_error_t msymGenerateSubrepresentationSpaces(msym_context ctx){
    (void) ctx;
    msymSetErrorDetails("Subrepresentation spaces are not included in XtalOpt's vendored libmsym subset");
    return MSYM_INVALID_SUBSPACE;
}
...
msym_error_t msymGetSALCs(msym_context ctx, int l, void *c, int *species, msym_partner_function_t *pf){
    ...
    (void) species;
    (void) pf;
    msymSetErrorDetails("SALCs are not included in XtalOpt's vendored libmsym subset");
    return MSYM_INVALID_SUBSPACE;
}
...
msym_error_t msymSymmetrySpeciesComponents(msym_context ctx, int wfl, double *wf, int sl, double *s){
    ...
    (void) sl;
    (void) s;
    msymSetErrorDetails("Symmetry species components are not included in XtalOpt's vendored libmsym subset");
    return MSYM_INVALID_SUBSPACE;
}
...
msym_error_t msymSymmetrizeWavefunctions(msym_context ctx, int l, void *c, int *species, msym_partner_function_t *pf){
    ...
    (void) species;
    (void) pf;
    msymSetErrorDetails("Wavefunction symmetrization is not included in XtalOpt's vendored libmsym subset");
    return MSYM_INVALID_SUBSPACE;
}
