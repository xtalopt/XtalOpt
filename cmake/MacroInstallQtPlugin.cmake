...
macro(install_qt_plugin _qt_plugin_name _destination _qt_plugins_var)
  get_target_property(_qt_plugin_path "${_qt_plugin_name}" IMPORTED_LOCATION_RELEASE)
  if(NOT _qt_plugin_path)
    get_target_property(_qt_plugin_path "${_qt_plugin_name}" IMPORTED_LOCATION)
  endif()
  if(NOT _qt_plugin_path)
    get_target_property(_qt_plugin_path "${_qt_plugin_name}" IMPORTED_LOCATION_DEBUG)
  endif()
