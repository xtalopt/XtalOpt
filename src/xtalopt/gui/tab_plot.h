...
/**
 * The plot tab: charts of the search results.
 */
class TabPlot : public Search::AbstractTab
{
  Q_OBJECT

public:
  explicit TabPlot(Search::AbstractDialog* parent, XtalOpt* p);
