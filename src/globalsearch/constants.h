...
// Default values, constants, and conversion factors used in the code.
// The goal is to use these values/constants/factors (wherever they are needed)
//   instead of explicit numerical values to keep the code easier to maintain.

// Default value for spglib tolerance across the code (Angstroms units)
static const double SPGTOLDEF = 0.01;

// Default value for length tolerance (niggliReduce and isNiggliReduced)
static const double LENTOLDEF = 0.01;
