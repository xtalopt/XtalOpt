...
namespace GlobalSearch {
  ...
  /**
   * @class SSHManagerLibSSH sshmanager_libssh.h <globalsearch/sshmanager_libssh.h>
   *
  ...
  public:
     ...
     */
    explicit SSHManagerLibSSH(unsigned int connections = 5,
                              OptBase *parent = 0);

    /**
     * Destructor.
     */
    virtual ~SSHManagerLibSSH();
