...
/**
 * @class AbstractTab abstracttab.h <search/gui/abstracttab.h>
 *
 * @brief The base class for GUI tabs, preconfigured to work with
...
protected:
  /**
   * Show a modal warning message box to the user, parented to the tab's
   * dialog. Derived tabs use this so all the error prompts look the same.
   *
   * @param instr The message to display.
   */
