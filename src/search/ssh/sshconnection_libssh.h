 ...
 * <search/ssh/sshconnection_libssh.h>
 *
 * @brief A class to handle command execution and sftp transactions
 * on an ssh server using the libssh method.
 *
...
public slots:
   ...
   * @param printWarning Prints warnings if an error occurs
   *
   ...
   * Search::SSHConnection::SSHConnectionException exceptions
