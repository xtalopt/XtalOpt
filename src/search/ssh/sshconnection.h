...
/**
 * @class SSHConnection sshconnection.h <search/ssh/sshconnection.h>
 *
 * @brief Handle commands and file transfers on an SSH server.
 *
 * @author David C. Lonie
 *
 * Do not create this class directly; use SSHManager. The system ssh uses
 * the system SSH tools and the user's SSH setup. The libssh method uses a
 * libssh connection and can ask for a password. The sshMethod setting selects
 * system, libssh, or auto. Auto tries system first.
 */
