...
/**
 * @class CASTEPOptimizer castepoptimizer.h <search/optimizers/castepoptimizer.h>
 *
 * @brief Optimizer interface for CASTEP.
 */
class CASTEPOptimizer : public Optimizer
{
  Q_OBJECT
...
public:
  ...
  explicit CASTEPOptimizer(SearchBase* parent);
  virtual ~CASTEPOptimizer() override;
