...
#ifndef GLOBALXRD_XRD_PLOT_H
#define GLOBALXRD_XRD_PLOT_H
...
// Widget for an X-ray diffraction pattern.
...
public:
  ...
  const std::vector<std::unique_ptr<QwtPlotCurve>>& plotCurves() const
  {
    return m_curveList;
  };
